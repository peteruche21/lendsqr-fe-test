                    ...
                    <div className="sidebar__groups">
                        <div className="nav-item-group">
                            ...
                            <div className="nav-item-group__items">
                                ...
                                />
                                <NavItem
                                    active={currentPath.startsWith('/guarantors')}
                                    href="/guarantors"
                                    icon={<UserGroupIcon />}
                                    label="Guarantors"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/loans')}
                                    href="/loans"
                                    icon={<SackIcon />}
                                    label="Loans"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/decision-models')}
                                    href="/decision-models"
                                    icon={<HandshakeIcon />}
                                    label="Decision Models"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/savings')}
                                    href="/savings"
                                    icon={<PiggybankIcon />}
                                    label="Savings"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/loan-requests')}
                                    href="/loan-requests"
                                    icon={<LoanIcon />}
                                    label="Loan Requests"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/whitelist')}
                                    href="/whitelist"
                                    icon={<UserCheckIcon />}
                                    label="Whitelist"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/karma')}
                                    href="/karma"
                                    icon={<UserXIcon />}
                                    label="Karma"
                                />
                        ...
                        <div className="nav-item-group">
                            ...
                            <div className="nav-item-group__items">
                                <NavItem
                                    active={currentPath.startsWith('/organization')}
                                    href="/organization"
                                    icon={<BriefCaseIcon />}
                                    label="Organization"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/loan-products')}
                                    href="/loan-products"
                                    icon={<LoanIcon />}
                                    label="Loan Products"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/savings-products')}
                                    href="/savings-products"
                                    icon={<BankIcon />}
                                    label="Savings Products"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/fees-and-charges')}
                                ...
                                />
                                <NavItem
                                    active={currentPath.startsWith('/service-account')}
                                    href="/service-account"
                                    icon={<UserGearIcon />}
                                    label="Service Account"
                                />
                                <NavItem
                                    active={currentPath.startsWith('/settlements')}
                                    href="/settlements"
                                    icon={<ScrollIcon />}
                                    label="Settlements"
                                />
                        ...
                        <div className="nav-item-group">
                            ...
                            <div className="nav-item-group__items">
                                ...
                                />
                                <NavItem
                                    active={currentPath.startsWith('/fees-and-pricing')}
                                ...
                                />
                                <NavItem
                                    active={currentPath.startsWith('/systems-messages')}
