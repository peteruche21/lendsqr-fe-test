...
type UserTableFilterProps = {
  ...
  label: string
  onChange: <Field extends UserFilterField>(
    field: Field,
...
export function UserTableFilter({
  ...
  return (
    <Card as="div" className="user-table-filter">
      ...
      {hasValue ? (
        <Button
          className="user-table-filter__button"
          variant="outline"
    ...
    case 'dateJoined':
      return (
        <FilterDate
          label={label}
          value={value}
          onChange={(nextValue) => onChange('dateJoined', nextValue)}
        />
      )
  ...
  return (
    <label className="user-table-filter__field">
      ...
      >
        ...
        />
        {value === '' ? (
          <span className="user-table-filter__date-placeholder">Date</span>
        ) : null}
